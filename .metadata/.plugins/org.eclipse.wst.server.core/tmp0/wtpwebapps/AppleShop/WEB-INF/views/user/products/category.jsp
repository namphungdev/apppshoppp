				...
				<div class="row-fluid">
					<ul class="thumbnails">
						<c:forEach var="item" items="${ productsPaginate }"
							...
							<li class="span4">
								<div class="thumbnail">
									<a href="chi-tiet-san-pham/${ item.id }" class="overlay"></a> <a
										class="zoomTool" href="chi-tiet-san-pham/${ item.id }"
										title="add to cart"><span class="icon-search"></span>
										Xem chi tiết</a> <a href="<c:url value="/chi-tiet-san-pham/${ item.id}"/>"><img
									...
									<div class="caption cntr">
										...
										<h4>
											<a class="shopBtn" href="<c:url value="/AddCart/${ item.id }"/>" title="add to cart"> Thêm vào giỏ hàng </a>
										</h4>
